...
const SignUpModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md mx-auto bg-slate-900 border-2 border-cyan-500/30 rounded-2xl shadow-2xl backdrop-blur-xl z-50 p-0 overflow-hidden">
        ...
        <div className="relative z-10 px-8 py-6 ">
          <DialogHeader className="text-center space-y-4 pb-2">
            ...
            <p className="text-gray-300 text-sm">Join thousands managing their finances smarter</p>
          </DialogHeader>
