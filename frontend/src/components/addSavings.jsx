...
const AddSavings = () => {
  ...
  const fetchGoals = async () => {
    try {
      const response = await fetch(`https://expense-planner-q3rf.vercel.app/api/savings/goals/${userId}`);
      if (response.ok) {
  ...
  const handleCreateGoal = async (e) => {
    ...
    try {
      const response = await fetch('https://expense-planner-q3rf.vercel.app/api/savings/goals', {
        method: 'POST',
  ...
  const handleAddMoney = async (e) => {
    ...
    try {
      const response = await fetch('https://expense-planner-q3rf.vercel.app/api/savings/transactions', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          user_id: userId,
  ...
  const handleDeleteGoal = async () => {
    ...
    try {
      const response = await fetch(`https://expense-planner-q3rf.vercel.app/api/savings/goals/${goalToDelete.id}`, {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
      });
